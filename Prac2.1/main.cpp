...
int main(void)
{
    ...
    if(err != CL_SUCCESS){
        printf("Error occurred while getting Device ID\n");
    }
    ...
    if(err != CL_SUCCESS){
        printf("Error occurred while creating context\n");
    }
	//------------------------------------------------------------------------
    ...
    if(err != CL_SUCCESS){
        printf("Error occurred while creating program from source\n");
    }
    ...
    if(err3 != CL_SUCCESS){
        printf("Error occurred while building program\n");
    }
	printf("program ID = %i\n", err3);
    ...
    if(err != CL_SUCCESS){
        printf("Error occurred while creating kernel\n");
    }
    ...
    if(err != CL_SUCCESS){
        printf("Error occurred while creating queue\n");
    }
	...
	argument1_buffer = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, sizeof(int), &argument2, &err);
    ...
    if(err4 != CL_SUCCESS){
        printf("Error occurred while queueing tasks\n");
    }
